...
date: 2023.02.16
excerpt: 从 BEM 规范到 TailwindCSS 的流行：我们看到了实用主义是如何重塑 CSS 的
topic:
  - css
  - engineering
---
...
<div class="flex gap-4">
  <img src="..." class="w-1/3" />
  <div class="w-2/3">
    <div class="text-lg text-neutral-8 line-clamp-2">And Then There Were None</div>
    <div class="text-neutral-5 mt-4">...</div>
    <button class="bg-neutral-800 text-white uppercase mt-4">MORE</button>
  </div>
</div>
```
