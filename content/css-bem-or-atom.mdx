...
<div class="flex gap-4">
  <img src="..." class="w-1/3" />
  <div class="w-2/3">
    <div class="text-lg text-gray-8 line-clamp-2">And Then There Were None</div>
    <div class="text-gray-5 mt-4">...</div>
    <button class="bg-gray-800 text-white uppercase mt-4">MORE</button>
  </div>
</div>
```
