...
date: 2021.12.18
excerpt: 每个编写 CSS 的人都应当了解 PostCSS 是什么、不是什么，以及我们能用它实现什么
topic: 
  - engineering
  - css
---

PostCSS 是一项时常被提起的技术，但与它的知名度不相匹配的则是相当多的对 PostCSS 的误解。习惯于使用样式预处理器的开发者们往往忽视了 CSS 领域的其他技术。对于 PostCSS，即便不使用它，对每一个编写 CSS 的人而言也都应当对 PostCSS 有基本的了解，认识它是什么、不是什么，以及在它的能力范围内能做到什么。
...
<Callout title="扁平化语法结构" type="info" icon="FileEdit">
