<template>
  <NuxtLink
    :to="item.path"
    class="grid grid-cols-12 gap-x-4 gap-y-2 lg:gap-y-4 group text-lg relative font-bold hover:text-slate-100 dark:hover:text-slate-950 transition-all duration-300 ease-in-out mb-6 lg:mb-0"
  ...
  >
    <div class="col-span-12 lg:col-span-4 relative lg:py-2">
      <div
        :class="cls"
        class="absolute hover-bg bg-slate-950 dark:bg-slate-100 w-full h-full left-0 top-0 origin-top scale-y-0"
      ></div>
      <div
    ...
    >
      <div
        class="lg:absolute top-1/2 lg:-translate-y-1/2 flex items-center gap-4 scale-100 lg:scale-80 group-hover:scale-100 opacity-0 group-hover:opacity-100 transition-all duration-300 w-full left-0 right-0"
      >
        <NuxtImg
